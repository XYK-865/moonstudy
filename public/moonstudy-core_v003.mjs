...
function _M0TPB8MutLocalGORPB5ArrayGRP29moonstudy9moonstudy11StudyRecordEE(param0) {
  this.val = param0;
}
...
function _M0MPC16option6Option6unwrapGRPB5EntryGsiEE(self) {
  if (self === undefined) {
    return $panic();
  } else {
    const _Some = self;
...
function _M0MPB3Map20add__entry__to__tailGsiE(self, idx, entry) {
  ...
  if (_bind === -1) {
    ...
    _M0MPC16option6Option6unwrapGRPB5EntryGsiEE(_bind >>> 0 < _tmp.length ? _tmp[_bind] : $oob()).next = entry;
  }
  self.tail = idx;
...
function _M0MPC15array5Array3mapGRP29moonstudy9moonstudy11StudyRecordRPB4JsonE(self, f) {
...
function _M0MPC15array5Array3mapGRP29moonstudy9moonstudy9TopicStatRPB4JsonE(self, f) {
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
...
function _M0MPC15array5Array3mapGRP29moonstudy9moonstudy7DayStatRPB4JsonE(self, f) {
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
...
function _M0IPC15array5ArrayPB6ToJson8to__jsonGRP29moonstudy9moonstudy11StudyRecordE(self) {
  return new _M0DTPB4Json5Array(_M0MPC15array5Array3mapGRP29moonstudy9moonstudy11StudyRecordRPB4JsonE(self, (x) => _M0IP29moonstudy9moonstudy11StudyRecordPB6ToJson8to__json(x)));
}
function _M0IPC15array5ArrayPB6ToJson8to__jsonGRP29moonstudy9moonstudy9TopicStatE(self) {
  return new _M0DTPB4Json5Array(_M0MPC15array5Array3mapGRP29moonstudy9moonstudy9TopicStatRPB4JsonE(self, (x) => _M0IP29moonstudy9moonstudy9TopicStatPB6ToJson8to__json(x)));
}
function _M0IPC15array5ArrayPB6ToJson8to__jsonGRP29moonstudy9moonstudy7DayStatE(self) {
  return new _M0DTPB4Json5Array(_M0MPC15array5Array3mapGRP29moonstudy9moonstudy7DayStatRPB4JsonE(self, (x) => _M0IP29moonstudy9moonstudy7DayStatPB6ToJson8to__json(x)));
}
...
function _M0MPC15array5Array6filterGRP29moonstudy9moonstudy11StudyRecordE(self, f) {
  const arr = [];
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0IP29moonstudy9moonstudy15StorageEnvelopePC14json8FromJson10from__json(_x_258, _x_259) {
  const _de_schema_version_261 = new _M0TPB8MutLocalGOiE(undefined);
  const _de_records_260 = new _M0TPB8MutLocalGORPB5ArrayGRP29moonstudy9moonstudy11StudyRecordEE(_M0DTPC16option6OptionGRPB5ArrayGRP29moonstudy9moonstudy11StudyRecordEE4None__);
  let _map;
  _L: {
    if (_x_258.$tag === 6) {
  ...
  _L$2: {
    _L$3: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "schema_version");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v, _M0MPC14json8JsonPath8add__key(_x_259, "schema_version"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_schema_version_261.val = _tmp;
  }
  let _v$2;
  _L$3: {
    _L$4: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "records");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP29moonstudy9moonstudy11StudyRecordE(_v$2, _M0MPC14json8JsonPath8add__key(_x_259, "records"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_records_260.val = new _M0DTPC16option6OptionGRPB5ArrayGRP29moonstudy9moonstudy11StudyRecordEE4Some(_tmp);
  }
  let _de_schema_version_261$2;
  const _bind = _de_schema_version_261.val;
  if (_bind === undefined) {
    ...
    const _Some = _bind;
    const _v$3 = _Some;
    _de_schema_version_261$2 = _v$3;
  }
  let _de_records_260$2;
  const _bind$2 = _de_records_260.val;
  if (_bind$2.$tag === 1) {
    const _Some = _bind$2;
    const _v$3 = _Some._0;
    _de_records_260$2 = _v$3;
  } else {
...
function _M0IP29moonstudy9moonstudy13StorageActionPB6ToJson8to__json(_x_250) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "ok", _M0IPC14bool4BoolPB6ToJson8to__json(_x_250.ok));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "message", _M0IPC16string6StringPB6ToJson8to__json(_x_250.message));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "storage_json", _M0IPC16string6StringPB6ToJson8to__json(_x_250.storage_json));
  return _M0MPC14json4Json6object($36$map);
}
function _M0IP29moonstudy9moonstudy11StudyRecordPB6ToJson8to__json(_x_239) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "id", _M0IPC16string6StringPB6ToJson8to__json(_x_239.id));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "date", _M0IPC16string6StringPB6ToJson8to__json(_x_239.date));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "topic", _M0IPC16string6StringPB6ToJson8to__json(_x_239.topic));
  ...
  _M0MPB3Map3setGsRPB4JsonE($36$map, "note", _M0IPC16string6StringPB6ToJson8to__json(_x_239.note));
  return _M0MPC14json4Json6object($36$map);
}
function _M0IP29moonstudy9moonstudy11StudyRecordPC14json8FromJson10from__json(_x_204, _x_205) {
  const _de_topic_211 = new _M0TPB8MutLocalGOsE(undefined);
  const _de_note_210 = new _M0TPB8MutLocalGOsE(undefined);
  const _de_minutes_209 = new _M0TPB8MutLocalGOiE(undefined);
  const _de_id_208 = new _M0TPB8MutLocalGOsE(undefined);
  const _de_date_207 = new _M0TPB8MutLocalGOsE(undefined);
  const _de_completed_206 = new _M0TPB8MutLocalGObE(-1);
  let _map;
  _L: {
    if (_x_204.$tag === 6) {
  ...
  _L$2: {
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v, _M0MPC14json8JsonPath8add__key(_x_205, "id"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$3: {
    _L$4: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "date");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$2, _M0MPC14json8JsonPath8add__key(_x_205, "date"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_date_207.val = _tmp;
  }
  let _v$3;
  _L$4: {
    _L$5: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "topic");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$3, _M0MPC14json8JsonPath8add__key(_x_205, "topic"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_topic_211.val = _tmp;
  }
  let _v$4;
  _L$5: {
    _L$6: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "minutes");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v$4, _M0MPC14json8JsonPath8add__key(_x_205, "minutes"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_minutes_209.val = _tmp;
  }
  let _v$5;
  _L$6: {
    _L$7: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "completed");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC14bool4BoolPC14json8FromJson10from__json(_v$5, _M0MPC14json8JsonPath8add__key(_x_205, "completed"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_completed_206.val = _tmp;
  }
  let _v$6;
  _L$7: {
    _L$8: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "note");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$6, _M0MPC14json8JsonPath8add__key(_x_205, "note"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_note_210.val = _tmp;
  }
  let _de_topic_211$2;
  const _bind = _de_topic_211.val;
  if (_bind === undefined) {
    ...
    const _Some = _bind;
    const _v$7 = _Some;
    _de_topic_211$2 = _v$7;
  }
  let _de_note_210$2;
  const _bind$2 = _de_note_210.val;
  if (_bind$2 === undefined) {
  ...
  const _bind$3 = _de_minutes_209.val;
  if (_bind$3 === undefined) {
    ...
    const _Some = _bind$3;
    const _v$7 = _Some;
    _de_minutes_209$2 = _v$7;
  }
  let _de_id_208$2;
  const _bind$4 = _de_id_208.val;
  ...
  let _de_date_207$2;
  const _bind$5 = _de_date_207.val;
  if (_bind$5 === undefined) {
  ...
  const _bind$6 = _de_completed_206.val;
  if (_bind$6 === -1) {
...
function _M0IP29moonstudy9moonstudy14ActivityResultPB6ToJson8to__json(_x_201) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "ok", _M0IPC14bool4BoolPB6ToJson8to__json(_x_201.ok));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "message", _M0IPC16string6StringPB6ToJson8to__json(_x_201.message));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "days", _M0IPC15array5ArrayPB6ToJson8to__jsonGRP29moonstudy9moonstudy7DayStatE(_x_201.days));
  return _M0MPC14json4Json6object($36$map);
}
function _M0IP29moonstudy9moonstudy9ViewStatePB6ToJson8to__json(_x_196) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "ok", _M0IPC14bool4BoolPB6ToJson8to__json(_x_196.ok));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "message", _M0IPC16string6StringPB6ToJson8to__json(_x_196.message));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "records", _M0IPC15array5ArrayPB6ToJson8to__jsonGRP29moonstudy9moonstudy11StudyRecordE(_x_196.records));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "summary", _M0IP29moonstudy9moonstudy12StudySummaryPB6ToJson8to__json(_x_196.summary));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "topics", _M0IPC15array5ArrayPB6ToJson8to__jsonGRP29moonstudy9moonstudy9TopicStatE(_x_196.topics));
  return _M0MPC14json4Json6object($36$map);
}
function _M0IP29moonstudy9moonstudy9TopicStatPB6ToJson8to__json(_x_185) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "topic", _M0IPC16string6StringPB6ToJson8to__json(_x_185.topic));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "minutes", _M0IPC13int3IntPB6ToJson8to__json(_x_185.minutes));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "record_count", _M0IPC13int3IntPB6ToJson8to__json(_x_185.record_count));
  return _M0MPC14json4Json6object($36$map);
}
function _M0IP29moonstudy9moonstudy7DayStatPB6ToJson8to__json(_x_176) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "date", _M0IPC16string6StringPB6ToJson8to__json(_x_176.date));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "minutes", _M0IPC13int3IntPB6ToJson8to__json(_x_176.minutes));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "record_count", _M0IPC13int3IntPB6ToJson8to__json(_x_176.record_count));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "completed_count", _M0IPC13int3IntPB6ToJson8to__json(_x_176.completed_count));
  return _M0MPC14json4Json6object($36$map);
}
function _M0IP29moonstudy9moonstudy12StudySummaryPB6ToJson8to__json(_x_165) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "today_minutes", _M0IPC13int3IntPB6ToJson8to__json(_x_165.today_minutes));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "week_minutes", _M0IPC13int3IntPB6ToJson8to__json(_x_165.week_minutes));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "total_minutes", _M0IPC13int3IntPB6ToJson8to__json(_x_165.total_minutes));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "record_count", _M0IPC13int3IntPB6ToJson8to__json(_x_165.record_count));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "completed_count", _M0IPC13int3IntPB6ToJson8to__json(_x_165.completed_count));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "completion_rate", _M0IPC13int3IntPB6ToJson8to__json(_x_165.completion_rate));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "top_topic", _M0IPC16string6StringPB6ToJson8to__json(_x_165.top_topic));
  return _M0MPC14json4Json6object($36$map);
}
function _M0IP29moonstudy9moonstudy12ReportResultPB6ToJson8to__json(_x_162) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "ok", _M0IPC14bool4BoolPB6ToJson8to__json(_x_162.ok));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "message", _M0IPC16string6StringPB6ToJson8to__json(_x_162.message));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "markdown", _M0IPC16string6StringPB6ToJson8to__json(_x_162.markdown));
  return _M0MPC14json4Json6object($36$map);
}
...
function _M0FP29moonstudy9moonstudy10date__part(date, start, end) {
  ...
  while (true) {
    if (index.val < end) {
      const _tmp = Math.imul(value.val, 10) | 0;
      const _tmp$2 = index.val;
      value.val = (_tmp + (_tmp$2 >>> 0 < date.length ? date.charCodeAt(_tmp$2) : $oob()) | 0) - 48 | 0;
...
function _M0FP29moonstudy9moonstudy16valid__iso__date(date) {
  if (date.length !== 10 || (_M0IPC16uint166UInt16PB2Eq10not__equal(4 >>> 0 < date.length ? date.charCodeAt(4) : $oob(), 45) || _M0IPC16uint166UInt16PB2Eq10not__equal(7 >>> 0 < date.length ? date.charCodeAt(7) : $oob(), 45))) {
    return false;
  }
  const index = new _M0TPB8MutLocalGiE(0);
  while (true) {
    if (index.val < 10) {
      if (index.val !== 4 && index.val !== 7) {
        const _tmp = index.val;
        const code = _tmp >>> 0 < date.length ? date.charCodeAt(_tmp) : $oob();
        if (code < 48 || code > 57) {
          return false;
        }
      }
...
function _M0FP29moonstudy9moonstudy16validate__record(record) {
  return record.id.length === 0 ? "记录编号不能为空" : !_M0FP29moonstudy9moonstudy16valid__iso__date(record.date) ? "日期必须是真实的 YYYY-MM-DD 日期" : _M0MPC16string10StringView9to__owned(_M0MPC16string6String4trim(record.topic, undefined)).length === 0 ? "请填写学习内容" : record.topic.length > 100 ? "学习内容不能超过 100 个字符" : record.note.length > 500 ? "备注不能超过 500 个字符" : record.minutes <= 0 ? "学习时长必须大于 0 分钟" : record.minutes > 1440 ? "单条学习时长不能超过 1440 分钟" : undefined;
}
function _M0FP29moonstudy9moonstudy19add__topic__minutes(totals, positions, topic, minutes) {
  ...
  _L: {
    ...
    if (_bind === undefined) {
      const index$2 = totals.length;
      _M0MPB3Map3setGsiE(positions, topic, index$2);
      _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(totals, new _M0TP29moonstudy9moonstudy10TopicTotal(topic, minutes, 1, index$2));
      return;
    } else {
      const _Some = _bind;
      const _index = _Some;
  ...
  const current = _M0MPC15array5Array2atGRP29moonstudy9moonstudy10TopicTotalE(totals, index);
  _M0MPC15array5Array3setGRP29moonstudy9moonstudy10TopicTotalE(totals, index, new _M0TP29moonstudy9moonstudy10TopicTotal(topic, current.minutes + minutes | 0, current.record_count + 1 | 0, current.first_index));
}
function _M0FP29moonstudy9moonstudy16find__top__topic(totals) {
  if (totals.length === 0) {
    return "暂无";
  }
  const best_topic = new _M0TPB8MutLocalGsE(_M0MPC15array5Array2atGRP29moonstudy9moonstudy10TopicTotalE(totals, 0).topic);
  const best_minutes = new _M0TPB8MutLocalGiE(_M0MPC15array5Array2atGRP29moonstudy9moonstudy10TopicTotalE(totals, 0).minutes);
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      if (total.minutes > best_minutes.val) {
        best_topic.val = total.topic;
        best_minutes.val = total.minutes;
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
    ...
    if (_ < _bind$2) {
      ...
      if (_M0IP016_24default__implPB7Compare6op__geGsE(record.date, start_date) && _M0IP016_24default__implPB7Compare6op__leGsE(record.date, end_date)) {
        ...
        _L: {
          ...
          const current = _M0MPC15array5Array2atGRP29moonstudy9moonstudy10TopicTotalE(result, index);
          _M0MPC15array5Array3setGRP29moonstudy9moonstudy10TopicTotalE(result, index, new _M0TP29moonstudy9moonstudy7DayStat(current.date, current.minutes + record.minutes | 0, current.record_count + 1 | 0, current.completed_count + completed_increment | 0));
        }
      }
      _tmp = _ + 1 | 0;
      continue;
...
function _M0FP29moonstudy9moonstudy9summarize(records, today, week_start) {
  const today_minutes = new _M0TPB8MutLocalGiE(0);
  const week_minutes = new _M0TPB8MutLocalGiE(0);
  const total_minutes = new _M0TPB8MutLocalGiE(0);
  const completed_count = new _M0TPB8MutLocalGiE(0);
  const topic_totals = [];
  const _bind = [];
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      const record = records[_];
      total_minutes.val = total_minutes.val + record.minutes | 0;
      if (record.date === today) {
        today_minutes.val = today_minutes.val + record.minutes | 0;
      }
      if (_M0IP016_24default__implPB7Compare6op__geGsE(record.date, week_start) && _M0IP016_24default__implPB7Compare6op__leGsE(record.date, today)) {
        week_minutes.val = week_minutes.val + record.minutes | 0;
      }
      if (record.completed) {
        completed_count.val = completed_count.val + 1 | 0;
      }
  ...
  if (count === 0) {
    ...
    completion_rate = (Math.imul(completed_count.val, 100) | 0) / count | 0;
  }
  return new _M0TP29moonstudy9moonstudy12StudySummary(today_minutes.val, week_minutes.val, total_minutes.val, count, completed_count.val, completion_rate, _M0FP29moonstudy9moonstudy16find__top__topic(topic_totals));
}
...
function _M0FP29moonstudy9moonstudy16add__to__storage(raw, id, date, topic, minutes, completed, note, today) {
  ...
  _L: {
    ...
    return new _M0TP29moonstudy9moonstudy13StorageAction(false, message, raw);
  }
...
function _M0FP29moonstudy9moonstudy16restore__storage(candidate) {
  if (_M0MPC16string10StringView9to__owned(_M0MPC16string6String4trim(candidate, undefined)).length === 0) {
    return new _M0TP29moonstudy9moonstudy13StorageAction(false, "备份文件为空", "");
  }
...
function _M0FP29moonstudy9moonstudy14safe__markdown(value) {
  ...
  const _bind$2 = "\\\\";
  const _tmp$2 = _M0MPC16string6String12replace__all(value, _tmp, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length));
  const _bind$3 = "\r";
  ...
  const _bind$20 = "\\]";
  return _M0MPC16string6String12replace__all(_tmp$18, _tmp$19, new _M0TPC16string10StringView(_bind$20, 0, _bind$20.length));
}
function _M0FP29moonstudy9moonstudy16weekly__markdown(records, week_start, today) {
  const weekly = _M0MPC15array5Array6filterGRP29moonstudy9moonstudy11StudyRecordE(records, (record) => _M0IP016_24default__implPB7Compare6op__geGsE(record.date, week_start) && _M0IP016_24default__implPB7Compare6op__leGsE(record.date, today));
  ...
  const minutes = new _M0TPB8MutLocalGiE(0);
  const completed_count = new _M0TPB8MutLocalGiE(0);
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      minutes.val = minutes.val + record.minutes | 0;
      if (record.completed) {
        completed_count.val = completed_count.val + 1 | 0;
      }
      _tmp = _ + 1 | 0;
  ...
  _M0IPB13StringBuilderPB6Logger13write__string(buf, "\n- 本周学习：");
  _M0IPB13StringBuilderPB6Logger13write__string(buf, _M0MPC13int3Int18to__string_2einner(minutes.val, 10));
...
function _M0FP29moonstudy9moonstudy15daily__markdown(records, date) {
  const daily = _M0MPC15array5Array6filterGRP29moonstudy9moonstudy11StudyRecordE(records, (record) => record.date === date);
  const minutes = new _M0TPB8MutLocalGiE(0);
  const completed_count = new _M0TPB8MutLocalGiE(0);
...
function _M0FP29moonstudy9moonstudy21report__from__storage(raw, week_start, today) {
  ...
  if (!_M0FP29moonstudy9moonstudy16valid__iso__date(week_start) || (!_M0FP29moonstudy9moonstudy16valid__iso__date(today) || _M0IP016_24default__implPB7Compare6op__gtGsE(week_start, today))) {
    return new _M0TP29moonstudy9moonstudy12ReportResult(false, "周报日期范围无效", "");
  }
...
function _M0FP29moonstudy9moonstudy28daily__report__from__storage(raw, date) {
  ...
  if (!_M0FP29moonstudy9moonstudy16valid__iso__date(date)) {
    return new _M0TP29moonstudy9moonstudy12ReportResult(false, "日报日期无效", "");
  }
