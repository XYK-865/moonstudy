...
function _M0TP29moonstudy9moonstudy9ViewState(param0, param1, param2, param3, param4) {
  this.ok = param0;
  this.message = param1;
  this.records = param2;
  this.summary = param3;
...
function _M0TP29moonstudy9moonstudy14ActivityResult(param0, param1, param2) {
  this.ok = param0;
  this.message = param1;
  this.days = param2;
}
...
function _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(self, value) {
...
function _M0IPC15array5ArrayPB6ToJson8to__jsonGRP29moonstudy9moonstudy9TopicStatE(self) {
  const _p = new Array(self.length);
  const _p$2 = self.length;
  let _tmp = 0;
  while (true) {
    ...
    if (_p$3 < _p$2) {
      const _p$4 = self[_p$3];
      _p[_p$3] = _M0IP29moonstudy9moonstudy9TopicStatPB6ToJson8to__json(_p$4);
      _tmp = _p$3 + 1 | 0;
      continue;
    } else {
      break;
...
function _M0IPC15array5ArrayPB6ToJson8to__jsonGRP29moonstudy9moonstudy7DayStatE(self) {
  const _p = new Array(self.length);
  const _p$2 = self.length;
  let _tmp = 0;
  while (true) {
    ...
    if (_p$3 < _p$2) {
      const _p$4 = self[_p$3];
      _p[_p$3] = _M0IP29moonstudy9moonstudy7DayStatPB6ToJson8to__json(_p$4);
      _tmp = _p$3 + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FPB22fixed__quick__sort__byGRP29moonstudy9moonstudy10TopicTotalE(arr, cmp, pred, limit) {
  ...
  while (true) {
    ...
    const _bind = _M0FPB24fixed__choose__pivot__byGRP29moonstudy9moonstudy10TopicTotalE(arr$2, cmp);
    ...
    const _bind$2 = _M0FPB20fixed__partition__byGRP29moonstudy9moonstudy10TopicTotalE(arr$2, cmp, _pivot_index);
    ...
    if (pred$2 === undefined) {
      ...
      if (cmp(_p$2, arr$2.buf[arr$2.start + _pivot | 0]) === 0) {
        ...
        _tmp = limit$3;
        _tmp$2 = _M0MPC15array12MutArrayView5sliceGRP29moonstudy9moonstudy10TopicTotalE(arr$2, i, len);
        _tmp$4 = _partitioned;
        _tmp$5 = balanced$2;
        continue;
      }
...
function _M0MPC15array5Array8sort__byGRP29moonstudy9moonstudy10TopicTotalE(self, cmp) {
  const _bind = self.length;
  _M0MPC15array12MutArrayView8sort__byGRP29moonstudy9moonstudy10TopicTotalE(new _M0TPB12MutArrayViewGRP29moonstudy9moonstudy10TopicTotalE(self, 0, _bind), cmp);
}
...
function _M0MPC14json12ParseContext12parse__array(ctx, remaining_available_depth) {
  ...
  _L: while (true) {
    ...
    if (x.$tag === 8) {
      ...
      _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(vec, _tmp$4);
  ...
  while (true) {
    if (cache.length <= level) {
      if (cache.length >= 1) {
        ...
        _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(cache, `${_last}${_M0MPC16string6String6repeat(" ", indent)}`);
      } else {
        _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(cache, "\n");
      }
      continue;
    } else {
      break;
      ...
      switch (_value.$tag) {
        case 6: {
          ...
          if (_members.size === 0) {
            ...
            _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(stack, new _M0DTPC14json10WriteFrame6Object(_M0MPB3Map4iterGsRPB4JsonE(_members), true));
          }
          break;
        }
        case 5: {
          ...
          if (_arr.length === 0) {
            ...
            _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(stack, new _M0DTPC14json10WriteFrame5Array(_arr, 0));
          }
          break;
        }
        case 4: {
    ...
    if (_bind.$tag === 2) {
      ...
      while (true) {
        ...
        if (i < _bind$2) {
          const x = _a[i];
          _Index._1 = i;
          const _bind$3 = _M0IP29moonstudy9moonstudy14StoredRecordV1PC14json8FromJson10from__json(x, _Index);
          let _tmp$3;
          if (_bind$3.$tag === 1) {
            const _ok = _bind$3;
            _tmp$3 = _ok._0;
          ...
          _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(_acc, _tmp$3);
          _tmp$2 = i + 1 | 0;
          continue;
        } else {
          _tmp = _acc;
      ...
      return new _M0DTPC16result6ResultGRPB5ArrayGRP29moonstudy9moonstudy14StoredRecordV1ERPC14json15JsonDecodeErrorE2Ok(_tmp);
    } else {
...
function _M0FP29moonstudy9moonstudy10date__part(date, start, end) {
  ...
  while (true) {
    if (index < end) {
      const _tmp = Math.imul(value, 10) | 0;
      const _tmp$2 = index;
      value = (_tmp + (_tmp$2 >>> 0 < date.length ? date.charCodeAt(_tmp$2) : $oob()) | 0) - 48 | 0;
      index = index + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP29moonstudy9moonstudy16valid__iso__date(date) {
  ...
  while (true) {
    if (index < 10) {
      if (index !== 4 && index !== 7) {
        const _tmp$2 = index;
        const code = _tmp$2 >>> 0 < date.length ? date.charCodeAt(_tmp$2) : $oob();
        if (code < 48 || code > 57) {
          return false;
        }
      }
...
function _M0FP29moonstudy9moonstudy19add__topic__minutes(totals, positions, topic, minutes) {
  ...
  if (_bind === undefined) {
    ...
    _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(totals, new _M0TP29moonstudy9moonstudy10TopicTotal(topic, minutes, 1, index));
    return;
  } else {
    const _Some = _bind;
    const _index = _Some;
...
function _M0FP29moonstudy9moonstudy12topic__stats(records) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      const total = totals[_];
      _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(result, new _M0TP29moonstudy9moonstudy9TopicStat(total.topic, total.minutes, total.record_count));
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      ...
      if (_M0IP016_24default__implPB7Compare6op__geGsE(record.date, start_date) && _M0IP016_24default__implPB7Compare6op__leGsE(record.date, end_date)) {
        ...
        const _bind$3 = _M0MPB3Map3getGsiE(positions, record.date);
        if (_bind$3 === undefined) {
          _M0MPB3Map3setGsiE(positions, record.date, result.length);
          _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(result, new _M0TP29moonstudy9moonstudy7DayStat(record.date, record.minutes, 1, completed_increment));
        } else {
          const _Some = _bind$3;
          const _index = _Some;
...
function _M0FP29moonstudy9moonstudy9summarize(records, today, week_start) {
  ...
  const topic_totals = [];
  const _bind = [];
  const topic_positions = _M0MPB3Map3MapGsiE(new _M0TPB9ArrayViewGUsiEE(_bind, 0, 0), undefined);
  const category_totals = [];
  const _bind$2 = [];
  const category_positions = _M0MPB3Map3MapGsiE(new _M0TPB9ArrayViewGUsiEE(_bind$2, 0, 0), undefined);
...
function _M0FP29moonstudy9moonstudy13load__storage(raw) {
  ...
  let _try_err;
  _L: {
    const _bind = _M0FPC14json13parse_2einner(new _M0TPC16string10StringView(raw, 0, raw.length), 1024);
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    const _bind$2 = _M0FPC14json10from__jsonGRP29moonstudy9moonstudy16StoredEnvelopeV1E(_tmp, undefined);
    let envelope;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      envelope = _ok._0;
    ...
    while (true) {
      ...
      if (_ < _bind$4) {
        const record = records[_];
        const _bind$5 = _M0FP29moonstudy9moonstudy16validate__record(record);
        if (_bind$5 === undefined) {
        } else {
...
function _M0FP29moonstudy9moonstudy32add__to__storage__with__category(raw, id, date, category, topic, minutes, completed, note, today) {
  ...
  const _bind = _M0FP29moonstudy9moonstudy16validate__record(record);
  if (_bind === undefined) {
  } else {
    const _Some = _bind;
  ...
  const _bind$2 = loaded.records;
  const _bind$3 = _bind$2.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind$3) {
      const existing = _bind$2[_];
      if (existing.id === id) {
  ...
  _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(records, record);
...
function _M0FP29moonstudy9moonstudy16add__to__storage(raw, id, date, topic, minutes, completed, note, today) {
  return _M0FP29moonstudy9moonstudy32add__to__storage__with__category(raw, id, date, "学习", topic, minutes, completed, note, today);
}
function _M0FP29moonstudy9moonstudy11view__state(raw, today, week_start) {
  const loaded = _M0FP29moonstudy9moonstudy13load__storage(raw);
  return new _M0TP29moonstudy9moonstudy9ViewState(loaded.ok, loaded.message, loaded.records, _M0FP29moonstudy9moonstudy9summarize(loaded.records, today, week_start), _M0FP29moonstudy9moonstudy12topic__stats(loaded.records));
}
function _M0FP29moonstudy9moonstudy21delete__from__storage(raw, id) {
  ...
  const remaining = [];
  let found = false;
  const _bind = loaded.records;
  const _bind$2 = _bind.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind$2) {
      const record = _bind[_];
      if (record.id === id) {
        found = true;
      } else {
        _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(remaining, record);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0FP29moonstudy9moonstudy17view__state__json(raw, today, week_start) {
  return _M0MPC14json4Json17stringify_2einner(_M0IP29moonstudy9moonstudy9ViewStatePB6ToJson8to__json(_M0FP29moonstudy9moonstudy11view__state(raw, today, week_start)), false, 0, undefined);
}
function _M0FP29moonstudy9moonstudy22add__to__storage__json(raw, id, date, topic, minutes, completed, note, today) {
  return _M0MPC14json4Json17stringify_2einner(_M0IP29moonstudy9moonstudy13StorageActionPB6ToJson8to__json(_M0FP29moonstudy9moonstudy16add__to__storage(raw, id, date, topic, minutes, completed, note, today)), false, 0, undefined);
}
function _M0FP29moonstudy9moonstudy27delete__from__storage__json(raw, id) {
  return _M0MPC14json4Json17stringify_2einner(_M0IP29moonstudy9moonstudy13StorageActionPB6ToJson8to__json(_M0FP29moonstudy9moonstudy21delete__from__storage(raw, id)), false, 0, undefined);
}
function _M0FP29moonstudy9moonstudy23activity__from__storage(raw, start_date, end_date) {
  const loaded = _M0FP29moonstudy9moonstudy13load__storage(raw);
  if (!loaded.ok) {
    return new _M0TP29moonstudy9moonstudy14ActivityResult(false, loaded.message, []);
  }
  if (!_M0FP29moonstudy9moonstudy16valid__iso__date(start_date) || (!_M0FP29moonstudy9moonstudy16valid__iso__date(end_date) || _M0IP016_24default__implPB7Compare6op__gtGsE(start_date, end_date))) {
    return new _M0TP29moonstudy9moonstudy14ActivityResult(false, "统计日期范围无效", []);
  }
  return new _M0TP29moonstudy9moonstudy14ActivityResult(true, "", _M0FP29moonstudy9moonstudy15activity__stats(loaded.records, start_date, end_date));
}
function _M0FP29moonstudy9moonstudy29activity__from__storage__json(raw, start_date, end_date) {
  return _M0MPC14json4Json17stringify_2einner(_M0IP29moonstudy9moonstudy14ActivityResultPB6ToJson8to__json(_M0FP29moonstudy9moonstudy23activity__from__storage(raw, start_date, end_date)), false, 0, undefined);
}
...
function _M0FP29moonstudy9moonstudy21export__storage__json(raw) {
  return _M0MPC14json4Json17stringify_2einner(_M0IP29moonstudy9moonstudy13StorageActionPB6ToJson8to__json(_M0FP29moonstudy9moonstudy15export__storage(raw)), false, 0, undefined);
}
function _M0FP29moonstudy9moonstudy22restore__storage__json(candidate) {
  ...
  while (true) {
    ...
    if (_p$3 < _p$2) {
      ...
      if (_M0IP016_24default__implPB7Compare6op__geGsE(_p$4.date, week_start) && _M0IP016_24default__implPB7Compare6op__leGsE(_p$4.date, today)) {
        _M0MPC15array5Array4pushGRP29moonstudy9moonstudy10TopicTotalE(_p, _p$4);
      }
      _tmp = _p$3 + 1 | 0;
      continue;
    } else {
...
function _M0FP29moonstudy9moonstudy27report__from__storage__json(raw, week_start, today) {
  return _M0MPC14json4Json17stringify_2einner(_M0IP29moonstudy9moonstudy12ReportResultPB6ToJson8to__json(_M0FP29moonstudy9moonstudy21report__from__storage(raw, week_start, today)), false, 0, undefined);
}
...
function _M0FP29moonstudy9moonstudy34daily__report__from__storage__json(raw, date) {
  return _M0MPC14json4Json17stringify_2einner(_M0IP29moonstudy9moonstudy12ReportResultPB6ToJson8to__json(_M0FP29moonstudy9moonstudy28daily__report__from__storage(raw, date)), false, 0, undefined);
}
...
function _M0FP29moonstudy9moonstudy20compare__weeks__json(raw, week_start, today) {
  return _M0MPC14json4Json17stringify_2einner(_M0IP29moonstudy9moonstudy14WeekComparisonPB6ToJson8to__json(_M0FP29moonstudy9moonstudy14compare__weeks(raw, week_start, today)), false, 0, undefined);
}
function _M0FP39moonstudy9moonstudy3web16moonstudy__ready() {
  return "MoonStudy MoonBit 已加载";
}
function _M0FP39moonstudy9moonstudy3web12empty__total(today, week_start) {
  return _M0FP29moonstudy9moonstudy9summarize([], today, week_start).total_minutes;
}
function _M0FP39moonstudy9moonstudy3web11read__state(raw, today, week_start) {
  return _M0FP29moonstudy9moonstudy17view__state__json(raw, today, week_start);
}
function _M0FP39moonstudy9moonstudy3web11add__record(raw, id, date, topic, minutes, completed, note, today) {
  return _M0FP29moonstudy9moonstudy22add__to__storage__json(raw, id, date, topic, minutes, completed, note, today);
}
function _M0FP39moonstudy9moonstudy3web14delete__record(raw, id) {
  return _M0FP29moonstudy9moonstudy27delete__from__storage__json(raw, id);
}
function _M0FP39moonstudy9moonstudy3web14weekly__report(raw, week_start, today) {
  return _M0FP29moonstudy9moonstudy27report__from__storage__json(raw, week_start, today);
}
function _M0FP39moonstudy9moonstudy3web13daily__report(raw, date) {
  return _M0FP29moonstudy9moonstudy34daily__report__from__storage__json(raw, date);
}
function _M0FP39moonstudy9moonstudy3web16activity__series(raw, start_date, end_date) {
  return _M0FP29moonstudy9moonstudy29activity__from__storage__json(raw, start_date, end_date);
}
function _M0FP39moonstudy9moonstudy3web14export__backup(raw) {
  return _M0FP29moonstudy9moonstudy21export__storage__json(raw);
}
function _M0FP39moonstudy9moonstudy3web15restore__backup(candidate) {
  return _M0FP29moonstudy9moonstudy22restore__storage__json(candidate);
}
function _M0FP39moonstudy9moonstudy3web16week__comparison(raw, week_start, today) {
  return _M0FP29moonstudy9moonstudy20compare__weeks__json(raw, week_start, today);
}
export { _M0FP39moonstudy9moonstudy3web16moonstudy__ready as moonstudy_ready, _M0FP39moonstudy9moonstudy3web12empty__total as empty_total, _M0FP39moonstudy9moonstudy3web11read__state as read_state, _M0FP39moonstudy9moonstudy3web11add__record as add_record, _M0FP39moonstudy9moonstudy3web14delete__record as delete_record, _M0FP39moonstudy9moonstudy3web14weekly__report as weekly_report, _M0FP39moonstudy9moonstudy3web13daily__report as daily_report, _M0FP39moonstudy9moonstudy3web16activity__series as activity_series, _M0FP39moonstudy9moonstudy3web14export__backup as export_backup, _M0FP39moonstudy9moonstudy3web15restore__backup as restore_backup, _M0FP39moonstudy9moonstudy3web16week__comparison as week_comparison }
